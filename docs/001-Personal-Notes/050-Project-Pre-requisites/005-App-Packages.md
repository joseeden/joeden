...
Use `uv` for Python project setup, dependency installation, and project virtual environments.

For the full setup notes, see [uv for Python Projects](docs/001-Personal-Notes/050-Project-Pre-requisites/006-UV.md). 

If VS Code cannot detect a project `.venv` as a notebook kernel, see [Unable to Detect Virtual Environment as Kernel in VS Code](docs/065-Software-Engineering/020-Python/099-Troubleshooting/030-Unable-to-Detect-Virtual-Environment-as-Kernel-in-VS-Code.md).
