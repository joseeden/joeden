...
For more information, please see [Pass the Hash Attack](../011-Threats-and-Attacks/050-Attacks.md#pass-the-hash-attack).
...
For more information, please see [Birthday Attack](../011-Threats-and-Attacks/050-Attacks.md#birthday-attack).
...
For more information, please see [Rainbow Table Attack](../011-Threats-and-Attacks/050-Attacks.md#rainbow-table-attack).

### Dictionary Attack 

A dictionary attack is a type of attack that uses a list of common words to guess a user's password. 

For more information, please see [Dictionary Attack](../011-Threats-and-Attacks/050-Attacks.md#dictionary-attack).

### Brute Force Attack 

A brute force attack uses every possible combination of letters, numbers, and symbols to guess a user's password.

For more information, please see [Brute Force  Attack](../011-Threats-and-Attacks/050-Attacks.md#brute-force-attack).
