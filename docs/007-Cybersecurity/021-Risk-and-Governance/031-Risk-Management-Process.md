...
1. **Identify Risks**
    ...
    - See [Risk Identification](/docs/007-Cybersecurity/021-Risk-and-Governance/032-Risk-Identification.md)
...
2. **Analyze Risks**
    ...
    - See [Risk Assessment](/docs/007-Cybersecurity/021-Risk-and-Governance/033-Risk-Assessment.md)

3. **Treat or Mitigate Risks**

    - Apply controls to treat the risks
    - Reduce, transfer, accept, or avoid the risk
    - See [Risk Treatment](/docs/007-Cybersecurity/021-Risk-and-Governance/034-Risk-Treatment.md)
