...
- Use [mandatory access controls (MAC)](/docs/007-Cybersecurity/026-Identity-and-Access-Management/008-Logical-Access.md#mandatory-access-control-mac) to enforce strict policies.
...
For more information, please see [Security Requirements.](/docs/007-Cybersecurity/023-Security-Architecture/003-Security-Requirements.md#common-criteria)
