...
- [Download the Windows Server 2019 ISO File.](/docs/007-Windows/001-Windows-Server-in-VirtualBox/002-Windows-Server-Core.md#overview)
- [Create a Windows Server VM in VirtualBox](/docs/007-Windows/001-Windows-Server-in-VirtualBox/002-Windows-Server-Core.md#windows-server-core-no-gui)
