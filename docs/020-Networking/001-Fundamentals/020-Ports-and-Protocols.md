...
- **MAC Flooding**
  ...
  - For more information, please see [MAC Address Flooding](/docs/025-Cybersecurity/051-List-of-Attacks/012-Layer-2-Attacks.md#mac-address-flooding)
...
For more information, please see [IEEE 802.1X Protocol](/docs/025-Cybersecurity/024-Infrastructure-and-Network/022-IEEE-Standards.md#ieee-8021x)
...
- **RADIUS** 
  ...
  - For more information, please see [RADIUS](/docs/025-Cybersecurity/024-Infrastructure-and-Network/020-Authentication-Protocols.md#radius)

- **TACACS+**
  - Cisco-proprietary protocol
  - Slower, relies on TCP, but adds security
  - Supports all networking protocols
  - For more information, please see [TACACS+](/docs/025-Cybersecurity/024-Infrastructure-and-Network/020-Authentication-Protocols.md#tacacs)
