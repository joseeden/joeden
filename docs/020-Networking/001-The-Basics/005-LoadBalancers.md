...
- **Other Web Application Security Tasks**
  ...
  - Protection against web-based attacks such as SQL injection and [cross-site scripting (XSS)](/docs/025-Cybersecurity/051-List-of-Attacks/099-Other-Attacks.md)
