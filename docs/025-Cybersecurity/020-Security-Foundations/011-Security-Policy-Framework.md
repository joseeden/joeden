...
These four documents are also considered Governance Elements. To learn more, please see [Governance Elements.](/docs/025-Cybersecurity/021-Risk-and-Governance/046-Governance-Elements.md)
...
For common security policies that may be implemented by ogranization to protect their data and assets, please see [Security Policies.](/docs/025-Cybersecurity/020-Security-Foundations/012-Security-Policies.md)