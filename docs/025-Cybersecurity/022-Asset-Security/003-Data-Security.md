...
For more information, please see [Data Classification.](/docs/025-Cybersecurity/022-Asset-Security/002-Data-Handling.md)
...
2. **Purging**
   ...
   - [Degaussing](/docs/025-Cybersecurity/022-Asset-Security/004-Destroying-Data.md#degaussing) may be needed for certain media.
