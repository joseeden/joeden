...
2. **Broken Authentication and Session Management**
   ...
   - Example: [Session hijacking](/docs/025-Cybersecurity/051-List-of-Attacks/005-Spoofing-Attacks.md#session-hijacking)

3. **Cross-Site Scripting (XSS)**
   - Attackers embed scripts in third-party websites that execute in victims’ browsers  
   - For more information, please see [Cross-Site Scripting (XSS)](/docs/025-Cybersecurity/051-List-of-Attacks/099-Other-Attacks.md)
...
8. **Cross-Site Request Forgery (CSRF/XSRF)**
   ...
   - For more information, please see [CSRF/XSRF](/docs/025-Cybersecurity/051-List-of-Attacks/099-Other-Attacks.md)
