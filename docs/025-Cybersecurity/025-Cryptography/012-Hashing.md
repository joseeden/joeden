...
For more information, please see [Digital Signatures in Asymmetric Encryptions.](/docs/025-Cybersecurity/025-Cryptography/010-Asymmetric-Encryption.md)
...
For more information, please see [Code Signing.](/docs/025-Cybersecurity/027-Software-Security/010-Application-Security.md#code-signing)
...
- **RSA (Rivest–Shamir–Adleman)**
  ...
  - See [Encryption Methods: RSA](/docs/025-Cybersecurity/025-Cryptography/010-Asymmetric-Encryption.md#rsa)
...
- **ECDSA (Elliptic Curve Digital Signature Algorithm)**
  ...
  - See [Encryption Methods: ECDSA](/docs/025-Cybersecurity/025-Cryptography/010-Asymmetric-Encryption.md#ecc-variations)

- **EdDSA (Edwards Curve Digital Signature Algorithm)**

  - Based on Edwards curves for digital signatures
  - Fast, secure, and resistant to several types of attacks
  - See [Encryption Methods: EdDSA](/docs/025-Cybersecurity/025-Cryptography/010-Asymmetric-Encryption.md#ecc-variations)
