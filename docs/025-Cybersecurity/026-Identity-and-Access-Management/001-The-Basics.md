...
| IAL 2 | <ul><li>High confidence in the claimed identity.</li><li>Verified attributes (e.g., government-issued ID).</li><li>Used for moderate-risk scenarios.</li><li>Veirfication can be remote or in-person</li></ul> |
