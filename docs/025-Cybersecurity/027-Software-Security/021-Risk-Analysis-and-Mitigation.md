...
- [SQL injection](/docs/025-Cybersecurity/051-List-of-Attacks/006-Injection-Attacks.md)
- [Cross-site scripting (XSS)](/docs/025-Cybersecurity/051-List-of-Attacks/099-Other-Attacks.md)
- [Cross-site request forgery (CSRF/XSRF)](/docs/025-Cybersecurity/051-List-of-Attacks/099-Other-Attacks.md)
- [Buffer overflows](/docs/025-Cybersecurity/051-List-of-Attacks/015-Overflow-Attacks.md)
...
- [Input validation](/docs/025-Cybersecurity/027-Software-Security/010-Application-Security.md#input-validation) on user input
- Encrypt sensitive data in databases
- Enforce the [principle of least privilege](/docs/025-Cybersecurity/026-Identity-and-Access-Management/005-IAM-Concepts.md#principle-of-least-privilege) for user accounts
...
For more information, please see [Sandboxing.](/docs/025-Cybersecurity/027-Software-Security/010-Application-Security.md#sandboxing)