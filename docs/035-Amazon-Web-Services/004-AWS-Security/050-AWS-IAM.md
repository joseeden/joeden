...
- **AWS-Managed Policies**
    ...
    - Hard to follow the [least privilege principle](/docs/025-Cybersecurity/026-Identity-and-Access-Management/005-IAM-Concepts.md#principle-of-least-privilege).
...
Open standard that enables the exchange of identity information between providers and applications. This also enables the SSO in AWS accounts. For more information, please see [SAML.](/docs/025-Cybersecurity/026-Identity-and-Access-Management/012-Identity-Federation.md#saml)
