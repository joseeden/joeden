...
<!-- **Note:** I've created a Function app prior to this lab. You can follow the steps in [Lab: Create Application Insights.](/docs/036-Microsoft-Azure/005-Azure-Monitoring/025-Lab-Create-Application-Insights.md#create-application-insights) -->

**Note:** I've created a Function app prior to this lab. You can follow the steps in [Lab: Create Application Insights.](/docs/036-Microsoft-Azure/000-Projects/025-Lab-Create-Application-Insights/README.md#create-application-insights)
