...
**Note**: The code below is an excerpt. To see the full, working version, please check out the [Jupyter Notebook.](https://github.com/joseeden/joeden/blob/master/docs/065-Software-Engineering/021-Jupyter-Notebooks/100-API-Management-in-Azure/Fetch-Weather-Data-using-OpenWeatherMap.ipynb)
