...
- **Azure AD DS (Azure Active Directory Domain Services)**
    ...
    - Supports [LDAP](/docs/025-Cybersecurity/024-Infrastructure-and-Network/020-Authentication-Protocols.md#ldap), [Kerberos](/docs/025-Cybersecurity/024-Infrastructure-and-Network/020-Authentication-Protocols.md#kerberos), and NTLM authentication 
