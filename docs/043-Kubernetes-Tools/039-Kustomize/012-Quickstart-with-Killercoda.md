...
If you prefer to set up your own cluster and install Kustomize, please see [Installing Kustomize](/docs/043-Kubernetes-Tools/039-Kustomize/013-Install-Kustomize.md).
