...
For the final project, we'll be using the **LAMP** stack application to deploy our own fictional e-commerce website that sells electronic devices. But for this one, we'll be using *MariaDB* in place of MySQL.
