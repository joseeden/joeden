...
A working lab on Git SCM Polling can be found in [Single-server Deployment.](/docs/050-Version-Control-and-CICD/004-Jenkins-Labs/030-Single-Server-Deployment.md)
...
As a recap of the previous lab on [Source Control Polling](/docs/050-Version-Control-and-CICD/004-Jenkins-Labs/013-Source-Control-Polling.md), SCM polling provides a more efficient way than periodically checking for updates in the source code. Another option is to use **git hooks**
