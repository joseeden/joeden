...
- [Setup Prometheus](/docs/053-Observability/010-Prometheus/011-Installation.md)
- [Setup Node Exporter on the nodes](/docs/053-Observability/010-Prometheus/017-Setting-up-Exporters.md)
