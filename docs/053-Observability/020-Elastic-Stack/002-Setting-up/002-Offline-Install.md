...
5. Reset the password for the `elastic` user.
    ...
    If you encounter the error below, you may need to [adjust the heap size.](/docs/053-Observability/020-Elastic-Stack/002-Setting-up/001-Using-Vagrant-and-VirtualBox.md#adjust-the-heap-size)
...
For more information, please see [SSL Configuration.](/docs/053-Observability/020-Elastic-Stack/002-Setting-up/003-SSL-Configuration.md)
...
For more information, please see [Sharing the Certificate.](/docs/053-Observability/020-Elastic-Stack/002-Setting-up/003-SSL-Configuration.md#share-the-ca-certificate-to-other-vms-optional)


## Next Steps 

- [Adjust the Heap Size](/docs/053-Observability/020-Elastic-Stack/002-Setting-up/001-Using-Vagrant-and-VirtualBox.md#share-the-certificate-to-other-vms-optional)
- [Share the Certificate to Other VMs (Optional)](/docs/053-Observability/020-Elastic-Stack/002-Setting-up/001-Using-Vagrant-and-VirtualBox.md#share-the-certificate-to-other-vms-optional)
- [Sample Search Index](/docs/053-Observability/020-Elastic-Stack/002-Setting-up/001-Using-Vagrant-and-VirtualBox.md#sample-search-index)
- [Sample Bulk Indexing](/docs/053-Observability/020-Elastic-Stack/002-Setting-up/001-Using-Vagrant-and-VirtualBox.md#sample-bulk-indexing)
