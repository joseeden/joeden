...
For further details, refer to [Using Vagrant to Setup Elastic Stack.](/docs/053-Observability/020-Elastic-Stack/002-Setting-up/001-Using-Vagrant-and-VirtualBox.md).
:::
