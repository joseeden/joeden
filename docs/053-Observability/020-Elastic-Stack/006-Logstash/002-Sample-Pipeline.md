...
1. Download the sample Apache web server log file below: [access_log.log](https://github.com/joseeden/joeden/tree/master/assets/elastic-stack/sample-logs)
...
4. Ensure that [Elasticsearch CA cert is shared to Logstash.](/docs/053-Observability/020-Elastic-Stack/002-Setting-up/001-Using-Vagrant-and-VirtualBox.md#share-the-certificate-to-other-vms-optional)
