...
1. Create the `grok-nginx.conf` file.
    ...
    - [grok-nginx.conf](@site/docs/053-Observability/020-Elastic-Stack/006-Logstash/Logstash-config-files/grok-nginx.conf)
...
1. Log in to the Logstash node as the root user and create the configuration file:
    ...
    - [grok-iis-server.conf](@site/docs/053-Observability/020-Elastic-Stack/006-Logstash/Logstash-config-files/grok-iis-server.conf)
...
1. Log in to the Logstash node as the **root** user and create the configuration file:
    ...
    - [grok-mongodb.conf](@site/docs/053-Observability/020-Elastic-Stack/006-Logstash/Logstash-config-files/grok-mongodb.conf)
...
1. Log in to the Logstash node as the **root** user and create the configuration file:
    ...
    - [grok-apache-access.conf](@site/docs/053-Observability/020-Elastic-Stack/006-Logstash/Logstash-config-files/grok-apache-access.conf)
