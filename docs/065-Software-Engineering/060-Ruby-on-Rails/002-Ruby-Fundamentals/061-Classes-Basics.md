...
2. **Adding multiple parameters at runtime**
    ...
    **NOTE:** The order of the arguments matters when passing them.
    ...
    For more information, see the [Attribute Accessors.](/docs/065-Software-Engineering/060-Ruby-on-Rails/002-Ruby-Fundamentals/062-Classes-Encapsulation.md#the-ruby-way-attribute-accessors)
