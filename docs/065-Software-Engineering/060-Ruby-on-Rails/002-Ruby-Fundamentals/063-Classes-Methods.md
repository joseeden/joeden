...
For more information on `attr_writer`, please [Attribute Accessors.](/docs/065-Software-Engineering/060-Ruby-on-Rails/002-Ruby-Fundamentals/062-Classes-Encapsulation.md#the-ruby-way-attribute-accessors)
...
**Keywords arguments** are discussed in detail in the [Custom Methods](/docs/065-Software-Engineering/060-Ruby-on-Rails/002-Ruby-Fundamentals/057-Custom-Methods.md#keyword-arguments) page, but as a quick recap, keyword arguments allow you to clearly assign values to specific parameters when calling a method, and they can also have default fallback values. 
