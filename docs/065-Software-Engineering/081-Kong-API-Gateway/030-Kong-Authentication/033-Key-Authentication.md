...
Make sure to disable other **global authentication methods**. For more information, please see [Conflicting Global Authentication Methods](/docs/065-Software-Engineering/081-Kong-API-Gateway/030-Kong-Authentication/032-HMAC-Authentication.md#conflicting-global-authentication-methods)
...
To create a consumer, please see [Create the Consumer](/docs/065-Software-Engineering/081-Kong-API-Gateway/017-Consumers-Plugins-Upstreams.md#create-the-kong-consumer).
