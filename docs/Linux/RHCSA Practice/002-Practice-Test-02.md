...
## Lab 06 - Configuring a Repository
...
## Lab 07 - Resetting the Root password
...
## Lab 08 - Installing an FTP Server

**Tasks:**

1. You are asked to install a FTP server.
2. The anonymous download should be enabled for /var/ftp/finance catalog. 
3. Note that you need to configure yum directly to the existing file server.
