...
Well, before anything else, I just want to point out that this isn't about the thrilling sci-fi series [The 100](https://en.wikipedia.org/wiki/The_100_%28TV_series%29).
...
I even wrote a post about it back then, which you can read [here](../2020-11-06-day-1-where-to-start/index.md).

![alt text](image-2.png)

I was full of spirit during the first few weeks.

I eagerly followed tutorial videos and worked through the labs in Coursera's [Git for Developers using Github](https://www.coursera.org/projects/git-for-developers-using-github), moved on to Todd McLeod's primer on [Visual Studio Code](https://www.udemy.com/course/visual-studio-code-tutorial/), and then started working my way through Al Sweigart's popular Python course, [Automate the Boring Stuff with Python](https://automatetheboringstuff.com/).
